	...
	sys.stdout.flush()
	  ...
	  print("{} Saving checkpoint of model...".format(datetime.now()))
          ...
          checkpoint_name = os.path.join(checkpoint_path,
                                         str(occlusion_ratio) + '_rnn_occludeCenter_model0.8.256_epoch'+str(epoch+1)+'top1.ckpt')
	  ...
	  print("{} Saving checkpoint of model...".format(datetime.now()))
          # save checkpoint of the model
          checkpoint_name = os.path.join(checkpoint_path,
                                         str(occlusion_ratio) + '_rnn_occludeCenter_model0.8.256_epoch'+str(epoch+1)+'top5.ckpt')
